  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<QuestionTypeRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<QuestionTypeRecord> createQuestionQuestionTypeRecordList =
            snapshot.data!;
        return Scaffold(
          key: scaffoldKey,
          backgroundColor: Color(0xFFF5F5F5),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              10.0, 10.0, 10.0, 10.0),
                          child: StreamBuilder<List<QuestionTypeRecord>>(
                            stream: queryQuestionTypeRecord(
                              singleRecord: true,
                            ),
                            builder: (context, snapshot) {
                              ...
                              List<QuestionTypeRecord>
                                  columnQuestionTypeRecordList = snapshot.data!;
                              // Return an empty Container when the item does not exist.
                              if (snapshot.data!.isEmpty) {
                                return Container();
                              }
                              final columnQuestionTypeRecord =
                                  columnQuestionTypeRecordList.isNotEmpty
                                      ? columnQuestionTypeRecordList.first
                                      : null;
